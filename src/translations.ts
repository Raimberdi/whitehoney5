...
export const TRANSLATIONS: Record<string, Record<string, string>> = {
  en: {
    ...
    nomadicCharmTitle: "5. Attach Nomadic Leather Charm (+ $5)",
  ...
  es: {
    ...
    nomadicCharmTitle: "5. Incluir Amuleto Nómada de Cuero (+ $5)",
  ...
  ru: {
    ...
    nomadicCharmTitle: "5. Кожаный талисман кочевников (+ $5)",
  ...
  ar: {
    ...
    nomadicCharmTitle: "٥. إرفاق تعويذة الجلد البدوية التقليدية (+ $5)",
  ...
  ur: {
    ...
    nomadicCharmTitle: "۵. روایتی بدو لیدر چام لگوائیں (+ $5)",
